...
const tono: Record<Tono, string> = {
  info: "border-hairline-strong bg-control-fuerte text-ink",
                ...
                {menu.map((m) => (
                  <span
                    ...
                    className={`rounded-lg px-3 py-2 text-sm ${
                      m.activo
                        ? "bg-control-fuerte font-medium text-ink"
                        : "text-muted"
                    }`}
                  >
                    {m.t}
                  ...
                  <table className="w-full min-w-[840px] text-left text-sm">
                    ...
                    <tbody className="divide-y divide-hairline">
                      {demoRows.map((r) => (
                        <tr
                          key={r.guia}
                          className="transition-colors duration-200 ease-[var(--ease-signal)] hover:bg-control"
                        >
